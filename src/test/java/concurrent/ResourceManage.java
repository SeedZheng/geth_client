...
public class ResourceManage {
    ...
    public void useResource(int userId){   
        try{  
        	semaphore.acquire();
        	System.out.println("userid:"+userId+"获准进入信号量,时间是:"+System.nanoTime());
        	Thread.sleep(500);
            //int id = getResourceId();//占到一个坑    
            System.out.println("userId:"+userId+"正在使用资源");    
           ...
           // resourceArray[id] = true;//退出这个坑    
            ...
            System.out.println("userid:"+userId+"退出信号量,时间是:"+System.nanoTime());
        }    
    }    
